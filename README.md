...
Data structure
 Weight: 5
 Project to be done in teams of 2 people (your team: Endurance Ossai)
...
GitHub repository: binary_trees
OBOBOBFile: 7-binary_tree_inorder.c
  
8. Post-order traversal
mandatory
OBOBOBWrite a function that goes through a binary tree using post-order traversal

Prototype: void binary_tree_postorder(const binary_tree_t *tree, void (*func)(int));
Where tree is a pointer to the root node of the tree to traverse
OBOBOBAnd func is a pointer to a function to call for each node. The value in the node must be passed as a parameter to this function.
If tree or func is NULL, do nothing
